      ...
      <section className="bg-primary text-primary-foreground py-16 md:py-24 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-primary-foreground/90 leading-relaxed text-base md:text-lg max-w-xl mb-4 font-semibold italic">Sua apólice de incêndio pagaria 100% dos seus ativos hoje? Ou a seguradora cortaria sua indenização pela metade?
